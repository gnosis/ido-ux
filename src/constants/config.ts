...
export const API_URL_DEVELOP_MATIC = process.env.REACT_APP_ADDITIONAL_SERVICES_API_URL_MATIC
export const API_URL_PRODUCTION_MATIC = process.env.REACT_APP_ADDITIONAL_SERVICES_API_URL_PROD_MATIC
...
export const NETWORK_URL_MATIC =
  process.env.REACT_APP_NETWORK_URL_MATIC || 'https://polygon-rpc.com'
