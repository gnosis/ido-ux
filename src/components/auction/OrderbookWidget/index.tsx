...
const addClearingPriceInfo = (
  ...
  const pricePointBottom: PricePointDetails = {
    ...
    totalVolumePerPriceFormatted: '0',
    askValueY: null,
    bidValueY: null,
    newOrderValueY: null,
  ...
  const { points } = pricePoints.reduce(
    (acc, pricePoint, index) => {
      ...
      const pricePointDetails: PricePointDetails = {
        ...
        totalVolumePerPriceFormatted: (price * totalVolume).toFixed(2),
        askValueY,
        bidValueY,
        newOrderValueY: null,
      ...
      if (!isBid) {
        ...
        const pricePointDetails: PricePointDetails = {
          ...
          totalVolumePerPriceFormatted: (price * (acc.totalVolume + volume)).toFixed(2),
