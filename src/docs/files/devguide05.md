...
2. A popup will appear where you will be prompted a list of available wallets that you can connect to the dapp. Select the wallet type you would like to connect to the Gnosis Auction dapp.
